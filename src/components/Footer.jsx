...
export default function Footer() {
  const socials = [
    ...
    { id: "wh", label: "WH", href: "whatsapp://send?phone=38345964715" },
    {
      id: "ln",
      label: "LN",
      href: "https://linkedin.com/in/rinorzeqiri"
    }
  ];

  return (
    <footer className="relative w-full overflow-hidden bg-[var(--custom-white)]">
          ...
          <div key={item.id} className="flex items-center">
            <h1 className="text-[100px] sm:text-[140px] md:text-[180px] lg:text-[250px] xl:text-[350px] font-extrabold leading-[0.8] md:leading-[0.7] lg:leading-[0.6] translate-y-1/4 md:translate-y-1/3">
              <Link
                ...
                className="text-[var(--custom-blue)] hover:text-[var(--custom-black)] transition-colors duration-300">
                {item.label}
              </Link>
            </h1>
