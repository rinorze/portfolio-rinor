...
export default function TextSlider() {
  ...
  return (
    <div className="relative w-full overflow-hidden py-10 bg-[var(--custom-white)] dark:bg-[var(--custom-black)]">
      <div
        className="absolute left-0 top-0 h-full w-16
        bg-gradient-to-r from-[var(--custom-white)] to-[var(--custom-white)]/0 
        dark:from-[var(--custom-black)] dark:to-[var(--custom-black)]/0
      ...
      <motion.div
        className="flex items-center text-[var(--custom-blue)] dark:text-[var(--custom-yellow)] uppercase whitespace-nowrap"
        animate={{ x: ["0%", "-50%"] }}
